...
export class DirectionKey {
  ...
  checkKey = (xPos:number, yPos:number) => {
    ...
    if (xPos > this.leftKey.xStart && xPos < this.leftKey.xEnd && yPos > this.leftKey.yStart && yPos < this.leftKey.yEnd) return Direction.Left;
    if (xPos > this.rightKey.xStart && xPos < this.rightKey.xEnd && yPos > this.rightKey.yStart && yPos < this.rightKey.yEnd) return Direction.Right;
    if (xPos > this.downKey.xStart && xPos < this.downKey.xEnd && yPos > this.downKey.yStart && yPos < this.downKey.yEnd) return Direction.Down;
    return 'null';
  };
}
